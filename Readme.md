...
* Deploy the extract-text function
    ...
    gcloud functions deploy extract-text --gen2 --runtime=python310 --region=us-east1 --source=. --entry-point=new_image_file --trigger-event-filters="type=google.cloud.storage.object.v1.finalized" --trigger-event-filters="bucket=calvin-images"  --env-vars-file env.yaml --project $PROJECT_ID

* Test with a sample image 
    gsutil cp sample.png gs://calvin-images/sample.png

* Review logs for function execution
    gcloud beta functions logs read extract-text --gen2 --limit=100 --region=us-east1 --project $PROJECT_ID
...
* Deploy the extract-syntax function
    ...
    gcloud functions deploy extract-syntax --gen2 --runtime=python310 --region=us-east1 --source=. --entry-point=new_text --trigger-topic=calvin-text-extract  --env-vars-file env.yaml --retry --project $PROJECT_ID

* Review logs for function execution
    gcloud beta functions logs read extract-syntax --gen2 --limit=100 --region=us-east1 --project $PROJECT_ID
...
* Deploy the data-writer function
    ...
    gcloud functions deploy data-writer --gen2 --runtime=python310 --region=us-east1 --source=. --entry-point=new_text --trigger-topic=calvin-data-writer  --env-vars-file env.yaml --retry --project $PROJECT_ID

* Review logs for function execution
    gcloud beta functions logs read data-writer --gen2 --limit=100 --region=us-east1 --project $PROJECT_ID

# Web frontend for access

* Deploy the web-ui function
    cd $CLONE_FOLDER/web-ui
    gcloud functions deploy web-ui --gen2 --allow-unauthenticated --runtime=python310 --region=us-east1 --source=. --entry-point=new_request --trigger-http --env-vars-file env.yaml --project $PROJECT_ID
...
* Deploy the extract-sentiment function
    ...
    gcloud functions deploy extract-sentiment --gen2 --runtime=python310 --region=us-east1 --source=. --entry-point=new_text --trigger-topic=calvin-text-extract  --env-vars-file env.yaml --retry --project $PROJECT_ID

* Review logs for function execution
    gcloud beta functions logs read extract-sentiment --gen2 --limit=100 --region=us-east1 --project $PROJECT_ID
...
* Deploy the extract-text function
    ...
    gcloud functions deploy delete-images --gen2 --runtime=python310 --region=us-east1 --source=. --entry-point=new_image_file --trigger-event-filters="type=google.cloud.storage.object.v1.deleted" --trigger-event-filters="bucket=calvin-images"  --env-vars-file env.yaml --project $PROJECT_ID
